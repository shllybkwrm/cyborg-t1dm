...
for i in ninterval:	
	...
	for x in fname:	
		print x," ",ninterval
		sl=plotallcol()
		arr,index=sl.reader("C:\Users\SHWETA\Desktop\AdityaCodeCorr\MYFILE105.csv")
		interval=(i*2)+1
		cols=[8]
		for y in cols:
			...
			histogramsave="C:\Users\SHWETA\Desktop\AdityaCodeCorr\Histogram"+index[y]+"_individual_"+str(x)+"_"+str(space)+"_Totalcount_"+str(maxcount)
			correlationsave="C:\Users\SHWETA\Desktop\AdityaCodeCorr\Spaced_CorrelationPlot_"+index[y]+"_individual_"+str(x)+"_"+str(space)+"_Totalcount_"+str(maxcount)+".pdf"
